...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{figure_01_feature_histograms_combined.png}
\caption{Feature-distribution comparison between the Kaggle source dataset and the two external target datasets. The first row compares Kaggle with NHANES, and the second row compares Kaggle with Pima.}
\label{fig:hist_combined}
\end{figure}
